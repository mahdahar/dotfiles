...
description: "Use this skill for PixiJS v8 Application setup and lifecycle: new Application() + async app.init(), key ApplicationOptions (size, background, renderer preference, resize, ticker, events, accessibility), app.stage/renderer/canvas/screen access, ResizePlugin/TickerPlugin/CullerPlugin usage, app.start()/app.stop(), and app.destroy() cleanup including releaseGlobalResources."
license: MIT
---
